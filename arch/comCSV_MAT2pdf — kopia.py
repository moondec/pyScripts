...
# ZMIANA: Lista zawiera teraz tylko te zmienne, które mają być analizowane
INTERESUJACE_CZLONY = ["SWin_1_2_1", "PPFD_BC_IN_1_1_1", "PPFD_1_2_1"]
ZMIENNE_RADIACYJNE = ["SWin_1_2_1", "PPFD_BC_IN_1_1_1", "PPFD_1_2_1"] # Zmienne, dla których rysujemy krzywą słońca
...
# ZMIANA: Całkowicie nowa logika obliczania i grupowania przesunięć dla wielu zmiennych
...
def generuj_raport_porownawczy(df_roczne: pd.DataFrame, sciezka_pdf: str, nazwa_grupy: str, rok: int):
    ...
    with PdfPages(sciezka_pdf) as pdf:
        for kolumna_bazowa in kolumny_do_rysowania:
            ...
            # ZMIANA: Rysuj krzywą słońca, jeśli to zmienna radiacyjna
