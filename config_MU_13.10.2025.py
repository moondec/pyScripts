...
CALIBRATION_RULES_BY_STATION = {
    ...
    ## Tlen2 "new" tower added by Klaudia- 19.07.2025 
    'TL2dT_CAL': {
        'SW_IN_1_1_2' : [
...
COLUMN_MAPPING_RULES = {
    'TUCZNO_MAP': {
        ...
        'Air_temp_Avg': 'TA_1_1_1', # WXT51_1_1', # WXT510
    ...
    'TLEN1_MAP': {
        ...
        'RH_1_1_1_Avg': 'RH_1_1_1',  # HMP 155 air humidity at 2m above ground
        'Ta_1_2_1_Avg': 'TA_1_2_1',  # HMP 155 air temp. at 30cm above ground
        'RH_1_2_1_Avg': 'RH_1_2_1',  # HMP 155 air humidity at 30cm above ground
        },
    'TLEN1_RAD_MAP': {
	    #Radiation – BF3H /BF5sensors (PPFD) operated on and off from 25-Apr-2013 17:30:00 until 02-Dec-2020??? and
    ...
    'TLEN1a_MAP': {
        ...
        'PPFD_BC_IN_1_1_1': 'PPFD_BC_IN_2_1_1', #LI191 -NEED CHANGE!!! (_1_1_1) ????
        'PPFD_BC_IN_1_1_2': 'PPFD_BC_IN_2_1_2', #LI191  -NEED CHANGE!!! (_1_1_2) ????
        ...
        'TA_2_2_1_Avg': 'TA_2_2_1', #CNR Temp.
        'G_1_1_1': 'G_2_1_1', # płytki glebowe Hukseflux model: HFP01SC-20 at 5cm depth 
        'G_2_1_1': 'G_2_1_2', # płytki glebowe Hukseflux model: HFP01SC-20 at 5cm depth 
        'G_3_1_1': 'G_2_1_3', # płytki glebowe Hukseflux model: HFP01SC-20 at 5cm depth 
        'G_4_1_1': 'G_2_1_4', # płytki glebowe Hukseflux model: HFP01SC-20 at 5cm depth 
        'G_5_1_1': 'G_2_1_5', # płytki glebowe Hukseflux model: HFP01SC-20 at 5cm depth 
        'G_6_1_1': 'G_2_1_6', # płytki glebowe Hukseflux model: HFP01SC-20 at 5cm depth 
        'G_7_1_1': 'G_2_1_7', # płytki glebowe Hukseflux model: HFP01SC-20 at 5cm depth 
        'G_8_1_1': 'G_2_1_8', # płytki glebowe Hukseflux model: HFP01SC-20 at 5cm depth 
        'G_9_1_1': 'G_2_1_9', # płytki glebowe Hukseflux model: HFP01SC-20 at 5cm depth 
        'G_10_1_1': 'G_2_1_10',# płytki glebowe Hukseflux model: HFP01SC-20 at 5cm depth 
        'G_1_1_1_Avg': 'G_2_1_1',# płytki glebowe Hukseflux model: HFP01SC-20 at 5cm depth 
        'G_2_1_1_Avg': 'G_2_1_2',# płytki glebowe Hukseflux model: HFP01SC-20 at 5cm depth 
        'G_3_1_1_Avg': 'G_2_1_3',# płytki glebowe Hukseflux model: HFP01SC-20 at 5cm depth 
        'G_4_1_1_Avg': 'G_2_1_4',# płytki glebowe Hukseflux model: HFP01SC-20 at 5cm depth 
        'G_5_1_1_Avg': 'G_2_1_5',# płytki glebowe Hukseflux model: HFP01SC-20 at 5cm depth 
        'G_6_1_1_Avg': 'G_2_1_6',# płytki glebowe Hukseflux model: HFP01SC-20 at 5cm depth 
        'G_7_1_1_Avg': 'G_2_1_7',# płytki glebowe Hukseflux model: HFP01SC-20 at 5cm depth 
        'G_8_1_1_Avg': 'G_2_1_8',# płytki glebowe Hukseflux model: HFP01SC-20 at 5cm depth 
        'G_9_1_1_Avg': 'G_2_1_9',# płytki glebowe Hukseflux model: HFP01SC-20 at 5cm depth 
        'G_10_1_1_Avg': 'G_2_1_10',# płytki glebowe Hukseflux model: HFP01SC-20 at 5cm depth 
        ...
        'SWC_1_1_1': 'SWC_2_1_1',# wilgotność gleby na 5 cm Czujniki wilgotności i temperstury gleby Acclima (ACC-SEN-SDI) - lokalizacja BRUZDA (w wartstwie mineralnej gleby otoczonej organiczną)
        'SWC_2_1_1': 'SWC_2_1_2',# wilgotność gleby na 5 cm Czujniki wilgotności i temperstury gleby Acclima (ACC-SEN-SDI) - lokalizacja BRUZDA (w wartstwie mineralnej gleby otoczonej organiczną)
        'SWC_3_1_1': 'SWC_2_1_3',# wilgotność gleby na 5 cm Czujniki wilgotności i temperstury gleby Acclima (ACC-SEN-SDI) - gleba mineralna
        'SWC_4_1_1': 'SWC_2_1_4',# wilgotność gleby na 5 cm Czujniki wilgotności i temperstury gleby Acclima (ACC-SEN-SDI) - gleba mineralna
        'SWC_5_1_1': 'SWC_2_1_5',# wilgotność gleby na 5 cm Czujniki wilgotności i temperstury gleby Acclima (ACC-SEN-SDI) - gleba mineralna
        ...
        'TS_1_1_1_Avg': 'TS_2_1_1',# temperatura gleby na 5 cm Czujniki wilgotności i temperstury gleby Acclima (ACC-SEN-SDI) - lokalizacja BRUZDA (w wartstwie mineralnej gleby otoczonej organiczną)
        'TS_2_1_1_Avg': 'TS_2_1_2',# temperatura gleby na 5 cm Czujniki wilgotności i temperstury gleby Acclima (ACC-SEN-SDI) - lokalizacja BRUZDA (w wartstwie mineralnej gleby otoczonej organiczną)
        'TS_3_1_1_Avg': 'TS_2_1_3',# temperatura gleby na 5 cm Czujniki wilgotności i temperstury gleby Acclima (ACC-SEN-SDI) - gleba mineralna
        'TS_4_1_1_Avg': 'TS_2_1_4',# temperatura gleby na 5 cm Czujniki wilgotności i temperstury gleby Acclima (ACC-SEN-SDI) - gleba mineralna
        'TS_5_1_1_Avg': 'TS_2_1_5',# temperatura gleby na 5 cm Czujniki wilgotności i temperstury gleby Acclima (ACC-SEN-SDI) - gleba mineralna
    ...
    'TLEN1a_CR1000X_MAP': {
        ...
        'P_1_2_1': 'P_2_1_2', # deszczomierz korytkowy 1  RM Young (52202H)
        'P_1_3_1': 'P_2_1_3', # deszczomierz korytkowy 2  RM Young (52202H)
        'TA_1_1_1': 'TA_2_1_1', #Termohigrometry HYGROvue5 air temp. at 2m above ground
        'TA_1_2_1': 'TA_2_2_1', #Termohigrometry HYGROvue5 air temp. at 30cm above ground
        'RH_1_1_1': 'RH_2_1_1', #Termohigrometry HYGROvue5 air humidity at 2m above ground
        'RH_1_2_1': 'RH_2_2_1', #Termohigrometry HYGROvue5  air humidity at 30cm above ground
        ...
        ## Tlen2 "OLD" tower (added by Klaudia- 19.07.2025) and "NEW" tower (added by Klaudia- 08.10.2025)
    'TLEN2_MAP': {
        ...
        'G_1_1_1': 'G_2_1_1', #-NEED CHANGE!!! (_5_1_1)?
        'G_2_1_1': 'G_2_1_2', #-NEED CHANGE!!! (_6_1_1)?
        'G_3_1_1': 'G_2_1_3', #-NEED CHANGE!!! (_7_1_1)?
        'G_4_1_1': 'G_2_1_4', #-NEED CHANGE!!! (_8_1_1)?
        'G_5_1_1': 'G_2_1_5', #-NEED CHANGE!!! (_9_1_1)? 
        'G_6_1_1': 'G_2_1_6', #-NEED CHANGE!!! (_10_1_1)?
        'G_7_1_1': 'G_2_1_7', #-NEED CHANGE!!! (_11_1_1)?
        'G_8_1_1': 'G_2_1_8', #-NEED CHANGE!!! (_12_1_1)?
        'G_9_1_1': 'G_2_1_9',  #-NEED CHANGE!!! (_13_1_1)?
        'G_10_1_1': 'G_2_1_10', #-NEED CHANGE!!! (_14_1_1)?
        # Soil moisture, 1 profile (10, 30, 50cm)- CS616- OLD tower
        'VW_1': 'SWC_1_1_1', # CS616 10cm #-NEED CHANGE!!! (_1_2_1)?
        'VW_2': 'SWC_1_2_1',  # CS616 30cm #-NEED CHANGE!!! (_1_3_1)?
        'VW_3': 'SWC_1_3_1', # CS616 50cm #-NEED CHANGE!!! (_1_4_1)?
        ...
        'SWC_1_1_1': 'SWC_2_1_1',  #-NEED CHANGE!!! (_1_1_1)?
        'SWC_2_1_1': 'SWC_2_1_2',  #-NEED CHANGE!!! (_1_1_2)?
        'SWC_3_1_1': 'SWC_2_1_3', #-NEED CHANGE!!! (_1_1_3)?
        'SWC_4_1_1': 'SWC_2_1_4', #-NEED CHANGE!!! (_1_1_4)?
        'SWC_5_1_1': 'SWC_2_1_5', #-NEED CHANGE!!! (_1_1_5)?
        'TS_1_1_1': 'TS_2_1_1',  #-NEED CHANGE!!! (_1_1_1)?
        'TS_2_1_1': 'TS_2_1_2', #-NEED CHANGE!!! (_1_1_2)?
        'TS_3_1_1': 'TS_2_1_3', #-NEED CHANGE!!! (_1_1_3)?
        'TS_4_1_1': 'TS_2_1_4', #-NEED CHANGE!!! (_1_1_4)?
        'TS_5_1_1': 'TS_2_1_5', #-NEED CHANGE!!! (_1_1_5)?
        ...
        'P_1_2_1': 'P_2_1_2', #Rain gauge 1 #-NEED CHANGE!!! (_1_1_3)?
        'P_1_3_1': 'P_2_1_3', #Rain gauge 2 #-NEED CHANGE!!! (_1_1_4)?
        ...
        'TA_1_1_1': 'TA_2_1_1', #air temp. at 2m above ground  #-NEED CHANGE!!! (_1_1_2)?
        'TA_1_2_1': 'TA_2_2_1', #air temp. at 30cm above ground  #-NEED CHANGE!!! (_1_2_2)?
        'RH_1_1_1': 'RH_2_1_1', #air humidity at 2m above ground #-NEED CHANGE!!! (_1_1_2)?
        'RH_1_2_1': 'RH_2_2_1', #air humidity at 30cm above ground  #-NEED CHANGE!!! (_1_2_2)?
        },
    'TLEN2_CR1000X_MAP': {
        ## Variables names for CR1000X Campbell datalogger replacing DataTacker (*since 29.07.2024 14:00:00) - variables names should match those for Tlen2 "new" tower
        ##PPFD Radiation – PQS1 operated on the "new tower" - DataTacker datalogger from 2018-08-01 16:30:00 until 2024-07-2024 14:00:00 (datalogger replaced by the CR1000X datalogger). Assumed as the SAME location (REPETITION)
        'PPFD_1_2_1': 'PPFD_IN_1_1_2', # PQS1 
        'PPFDr_1_2_1': 'PPFD_OUT_1_1_2', # PQS1
        ##CNR Variables - names consistent with DataTacker logger- CORRECT
        'SWin_1_2_1': 'SW_IN_1_1_1', # CNR4
        'SWout_1_2_1': 'SW_OUT_1_1_2', # CNR4
        'LWin_1_2_1': 'LW_IN_1_1_2', # CNR4
        'LWout_1_2_1': 'LW_OUT_1_1_2', # CNR4
        ...
        'PPFD_BC_IN_1_1_2': 'PPFD_BC_IN_2_1_2', #LI191  -NEED CHANGE!!! (_1_1_2)?
         ## Soil heat plates Hukseflux HFP01SC-20 at 5cm depth - all in ca. 5 cm depth?- NEW tower - INSTALLED AT THE SAME SITLE (LOCATION) AS Hukseflux HFP 01- all in ca. 5 cm depth (REPETITIONS?)
        'G_1_1_1_Avg': 'G_2_1_1', #-NEED CHANGE!!! (_5_1_1)?
        'G_2_1_1_Avg': 'G_2_1_2', #-NEED CHANGE!!! (_6_1_1)?
        'G_3_1_1_Avg': 'G_2_1_3', #-NEED CHANGE!!! (_7_1_1)?
        'G_4_1_1_Avg': 'G_2_1_4', #-NEED CHANGE!!! (_8_1_1)?
        'G_5_1_1_Avg': 'G_2_1_5', #-NEED CHANGE!!! (_9_1_1)? 
        'G_6_1_1_Avg': 'G_2_1_6', #-NEED CHANGE!!! (_10_1_1)?
        'G_7_1_1_Avg': 'G_2_1_7', #-NEED CHANGE!!! (_11_1_1)?
        'G_8_1_1_Avg': 'G_2_1_8', #-NEED CHANGE!!! (_12_1_1)?
        'G_9_1_1_Avg': 'G_2_1_9',  #-NEED CHANGE!!! (_13_1_1)?
        'G_10_1_1_Avg': 'G_2_1_10', #-NEED CHANGE!!! (_14_1_1)?
        ## Soil moisture and temperature at 5cm depth- Acclima (ACC-SEN-SDI) sensor- NEW tower-INSTALLED AT THE SAME SITLE (LOCATION) AS CS616 and T107 soil termometer at ca. 5 cm depth (REPETITIONS?)
        'SWC_1_1_1_Avg': 'SWC_2_1_1',  #-NEED CHANGE!!! (_1_1_1)?
        'SWC_2_1_1_Avg': 'SWC_2_1_2',  #-NEED CHANGE!!! (_1_1_2)?
        'SWC_3_1_1_Avg': 'SWC_2_1_3', #-NEED CHANGE!!! (_1_1_3)?
        'SWC_4_1_1_Avg': 'SWC_2_1_4', #-NEED CHANGE!!! (_1_1_4)?
        'SWC_5_1_1_Avg': 'SWC_2_1_5', #-NEED CHANGE!!! (_1_1_5)?
        'TS_1_1_1_Avg': 'TS_2_1_1',  #-NEED CHANGE!!! (_1_1_1)?
        'TS_2_1_1_Avg': 'TS_2_1_2', #-NEED CHANGE!!! (_1_1_2)?
        'TS_3_1_1_Avg': 'TS_2_1_3', #-NEED CHANGE!!! (_1_1_3)?
        'TS_4_1_1_Avg': 'TS_2_1_4', #-NEED CHANGE!!! (_1_1_4)?
        'TS_5_1_1_Avg': 'TS_2_1_5', #-NEED CHANGE!!! (_1_1_5)?
        ## Precipitation measurements- forest floor – Tipping Rain gauges RM Young (52202H)- NEW tower
        'P_1_2_1': 'P_2_1_2', #Rain gauge 1 #-NEED CHANGE!!! (_1_1_3)?
        'P_1_3_1': 'P_2_1_3', #Rain gauge 2 #-NEED CHANGE!!! (_1_1_4)?
        ## Air temperature and humidity- Alfa Tech/Rotronic, HYGRO CLIP HC2-S3 - NEW tower
